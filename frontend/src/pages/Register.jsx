    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-green-500 via-teal-500 to-cyan-600 relative overflow-hidden">
      ...
      >
        ...
        <button
          type="submit"
          disabled={loading}
          className="w-full py-3 rounded-xl bg-gradient-to-r from-green-500 to-cyan-600 text-white font-bold shadow-lg flex justify-center items-center gap-2 hover:scale-105 transition-transform"
        >
          {loading ? (
            <svg
